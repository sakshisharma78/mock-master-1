...
function Dashboard() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await fetch('https://mock-master-phfq.onrender.com/api/auth/dashboard', {
        method: 'GET',
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch('https://mock-master-phfq.onrender.com/api/resume/uploadPdfToText', {
        method: 'POST',
        headers: {
          'auth-token': localStorage.getItem('auth-token'),
        },
      ...
      if (data.filePath) {
        ...
        const atsResponse = await fetch('https://mock-master-phfq.onrender.com/api/ats/getResume', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
            'auth-token': localStorage.getItem('auth-token'),
